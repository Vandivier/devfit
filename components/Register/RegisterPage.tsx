...
export const RegisterPage: React.FC<RegisterPageProps> = () => {
    ...
    const [tagOptions, setTagOptions] = useState<{ key: number; text: string; value: number }[] | undefined>(undefined);
            ...
            {!tagOptions ? (
                ...
                <Container>
                    <Form>
                        ...
                        <Button type="submit" fluid onClick={handleLoginSubmit} loading={buttonLoading} disabled={buttonLoading}>
                            Submit
                        </Button>
                    </Form>
